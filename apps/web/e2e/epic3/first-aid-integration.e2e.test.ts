          ...
          'section-neuro': [
            {
              ...
              pageNumber: 156,
              snippet:
                'The frontal lobe contains the motor cortex and Brocas area for speech production.',
              confidence: 0.92,
              isHighYield: true,
              system: 'Neurology',
            },
...
test_withFirstAid.describe('First Aid Integration - Complete Workflow', () => {
   ...
   */
  test_withFirstAid(
    '10. Contextual loading with scroll debounce optimization',
    async ({ firstAidPage, page }) => {
      let apiCallCount = 0
