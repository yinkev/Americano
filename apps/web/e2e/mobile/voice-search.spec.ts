...
test.describe('Story 3.6 - Voice Search Functionality', () => {
  ...
  test.describe('Voice Search UI Elements', () => {
    test('should display microphone button when voice search is enabled', async ({ page, browserName }) => {
  ...
  test.describe('Voice Search Interaction', () => {
    ...
    test('should apply visual feedback during listening', async ({ page, context, browserName }) => {
      test.skip(browserName !== 'chromium', 'Speech API only in Chromium');
  ...
  test.describe('Browser Support Detection', () => {
    test('should hide voice button when SpeechRecognition is unsupported', async ({ page, browserName }) => {
    ...
    test('should show voice button only when enableVoiceSearch prop is true', async ({ page, browserName }) => {
      test.skip(browserName !== 'chromium', 'Speech API only in Chromium');
  ...
  test.describe('Permission Handling', () => {
    ...
    test('should gracefully handle speech recognition errors', async ({ page, context, browserName }) => {
      test.skip(browserName !== 'chromium', 'Speech API only in Chromium');
  ...
  test.describe('Integration with Search', () => {
    test('should preserve manual input when voice search is available', async ({ page, context, browserName }) => {
      test.skip(browserName !== 'chromium', 'Speech API only in Chromium');
