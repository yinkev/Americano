...
test.describe('Semantic Search - Complete Workflow', () => {
  ...
  test('should apply search filters', async ({ page }) => {
    ...
    const highYieldFilter = page.locator('[data-testid="filter-high-yield"], input[type="checkbox"]');
  ...
  test('should highlight query terms in results', async ({ page }) => {
    ...
    const highlights = page.locator('[data-testid="search-result-item"] mark, [data-testid="search-result-item"] .highlight');
...
test.describe('Search - Mobile Responsive', () => {
  ...
  test('should open mobile search overlay', async ({ page }) => {
    ...
    const searchButton = page.locator('[data-testid="mobile-search-button"], button[aria-label*="Search"]');
