...
describe('ReviewCard', () => {
  const mockReview = {
    ...
    highlights: {
      ...
      personalBests: [
        'Completed 6 missions in a week - new record!',
  ...
  describe('Insights Section', () => {
    ...
    it('should display patterns detected', () => {
      ...
      expect(screen.getByText('Consistently high performance in morning sessions')).toBeInTheDocument();
    });
    ...
    it('should handle very long text gracefully', () => {
      const longTextReview = {
        ...
        insights: {
          ...mockReview.insights,
          improvements: [
            'This is a very long improvement description that should be handled gracefully without breaking the layout or causing overflow issues in the component'.repeat(5),
          ],
        },
      };
