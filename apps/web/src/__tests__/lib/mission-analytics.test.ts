...
import { MissionStatus, AnalyticsPeriod } from '@prisma/client';
...
describe.skip('MissionAnalyticsEngine', () => {
  ...
  describe('recommendMissionAdjustments', () => {
    ...
    it('should recommend adding objectives for finishing early', async () => {
      ...
      expect(result.adjustments.objectiveTypes?.add).toContain(
        'review objectives'
      );
      expect(result.adjustments.objectiveTypes?.reason).toContain(
