...
describe('IRT Assessment Engine', () => {
  ...
  describe('validateIRTResponses', () => {
    ...
    it('should throw error for non-array input', () => {
      expect(() => validateIRTResponses('not an array' as any)).toThrow('Responses must be an array');
    });
    ...
    it('should throw error for difficulty < 0', () => {
      ...
      expect(() => validateIRTResponses(responses)).toThrow('itemDifficulty must be between 0 and 100');
    });
