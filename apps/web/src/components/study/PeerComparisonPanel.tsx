...
export function PeerComparisonPanel({ userId, courseId, className = '' }: PeerComparisonPanelProps) {
    ...
    return (
      <div className={`bg-white/95 backdrop-blur-xl rounded-lg p-6 shadow-[0_8px_32px_rgba(31,38,135,0.1)] ${className}`}>
        <div className="text-center py-8">
          ...
          <p className="text-[oklch(0.5_0.05_240)] mb-4" style={{ fontFamily: 'Inter, sans-serif' }}>
  ...
  return (
    <div className={`bg-white/95 backdrop-blur-xl rounded-lg p-6 shadow-[0_8px_32px_rgba(31,38,135,0.1)] ${className}`}>
      ...
      {/* Percentile Summary */}
      <div className="mb-8 p-4 rounded-lg" style={{ backgroundColor: `${getPercentileColor(userPercentile)}20` }}>
        <div className="flex items-center justify-between mb-2">
          <span className="text-2xl font-bold" style={{ color: getPercentileColor(userPercentile), fontFamily: 'DM Sans, sans-serif' }}>
            {userPercentile}th Percentile
          </span>
          <span className="text-sm text-[oklch(0.5_0.05_240)]" style={{ fontFamily: 'Inter, sans-serif' }}>
            {poolSize} students
          </span>
        </div>
        <p className="text-sm" style={{ fontFamily: 'Inter, sans-serif', color: getPercentileColor(userPercentile) }}>
      ...
      <div className="mb-8">
        <h4 className="text-sm font-semibold mb-4 text-[oklch(0.4_0.05_240)]" style={{ fontFamily: 'DM Sans, sans-serif' }}>
        ...
        <div className="relative h-24 mb-8">
          ...
          <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-xs text-[oklch(0.5_0.05_240)]">0.0</div>
      ...
      {commonOverconfidentTopics.length > 0 && (
        <div>
          <h4 className="text-sm font-semibold mb-3 text-[oklch(0.4_0.05_240)] flex items-center gap-2" style={{ fontFamily: 'DM Sans, sans-serif' }}>
      ...
      <div className="mt-6 pt-4 border-t border-[oklch(0.8_0.05_240)]">
        <p className="text-xs text-[oklch(0.5_0.05_240)]" style={{ fontFamily: 'Inter, sans-serif' }}>
          All peer data is anonymized and aggregated. No individual student data is visible.
