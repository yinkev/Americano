...
import { Home, Library, BookOpen, BarChart2, Settings, ChevronsUpDown, Check, Sparkles, Calendar } from "lucide-react"
    ...
    >
            ...
            <SidebarMenuButton size="lg" asChild className="hover:bg-white/60">
              <Link href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  ...
                  <span className="truncate text-xs text-muted-foreground/80">Medical Learning</span>
                </div>
              </Link>
            </SidebarMenuButton>
          </SidebarMenuItem>
      ...
      <SidebarContent className="bg-white/90 backdrop-blur-xl">
        <SidebarGroup className="px-2">
          <SidebarGroupLabel className="text-xs font-semibold text-muted-foreground/70 uppercase tracking-wider px-2">Navigation</SidebarGroupLabel>
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className="grid flex-1 text-left text-sm leading-tight">
                    ...
                    <span className="truncate text-xs text-muted-foreground/80">{activeUser.email}</span>
                  </div>
              ...
              >
                <div className="px-2 py-1.5 text-xs font-semibold text-muted-foreground/70">Switch Account</div>
                {users.map((user) => (
                  <DropdownMenuItem
                    key={user.email}
                    onClick={() => {
