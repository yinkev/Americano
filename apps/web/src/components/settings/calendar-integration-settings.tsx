...
import { AlertCircle, Calendar, CheckCircle, Clock, Loader2, LogOut, RefreshCw } from 'lucide-react'
          ...
          <>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[13px] text-muted-foreground">
                    Connect your calendar to get study time recommendations that avoid conflicts
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg" style={{ backgroundColor: 'oklch(0.95 0.01 230)' }}>
            ...
            <div className="space-y-4">
              ...
              <Alert
                ...
                style={{
                  ...
                  borderColor: 'oklch(0.7 0.15 145 / 0.3)',
                }}
              >
                ...
                <AlertDescription className="text-[13px]" style={{ color: 'oklch(0.3 0.15 145)' }}>
                  Your calendar is connected. The system will automatically sync your availability
                  daily and use it to suggest optimal study times that don't conflict with your
                  schedule.
                </AlertDescription>
              </Alert>
            </div>
