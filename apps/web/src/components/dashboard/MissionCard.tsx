...
export function MissionCard({
  ...
  return (
    <Card
      className="p-3 shadow-lg border relative overflow-hidden"
      style={{ borderColor: 'oklch(0.70 0.18 210)' }}
    >
      <div className="relative">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
          ...
          <div
            className="flex items-center gap-2 text-xs px-4 py-2 rounded-full shadow-md flex-shrink-0"
            style={{ backgroundColor: 'oklch(0.94 0.10 30)' }}
          >
        ...
        <div className="space-y-1.5 mb-3">
          {incompleteTasks.map((task) => (
            ...
            >
              <div
                className="h-3 w-3 rounded-full flex-shrink-0 shadow-md mt-0.5"
                style={{ backgroundColor: 'oklch(0.68 0.25 15)' }}
              />
        ...
        <motion.button
          ...
          style={{
            background: isStarting ? 'oklch(0.62 0.22 25)' : 'oklch(0.75 0.20 30)',
          }}
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-2 text-xs">
          <span className="text-muted-foreground whitespace-nowrap">
            {incompleteTasks.length} objectives remaining
          </span>
          <span
            className="font-semibold px-4 py-2 rounded-full whitespace-nowrap"
            style={{
