    ...
    if (active && payload && payload.length) {
      return (
        ...
        >
          ...
          <p className="text-[13px] mt-1 text-info">Your retention: {payload[0].value}%</p>
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-3 gap-4 text-[13px]">
        <div className="p-3 rounded-md" style={{ backgroundColor: 'oklch(0.97 0.01 230)' }}>
          ...
          <p className="text-[16px] font-semibold text-info">{Math.round(curve.R0 * 100)}%</p>
        </div>
        <div className="p-3 rounded-md" style={{ backgroundColor: 'oklch(0.97 0.01 230)' }}>
          <p style={{ color: 'oklch(0.6 0.03 230)' }} className="text-[13px] mb-1">
            Decay Rate (k)
          </p>
          <p className="text-[16px] font-semibold text-warning">{curve.k.toFixed(3)}</p>
        </div>
        <div className="p-3 rounded-md" style={{ backgroundColor: 'oklch(0.97 0.01 230)' }}>
          <p style={{ color: 'oklch(0.6 0.03 230)' }} className="text-[13px] mb-1">
            Half-Life
          </p>
          <p className="text-[16px] font-semibold text-success">{curve.halfLife.toFixed(1)} days</p>
        </div>
      </div>
