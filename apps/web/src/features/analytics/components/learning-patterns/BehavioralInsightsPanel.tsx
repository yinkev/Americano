...
import { BookOpen, Brain, CheckCircle2, Clock, TrendingUp, X } from 'lucide-react'
  ...
  if (insufficientData) {
    return (
      <Alert className="bg-warning/10 border-warning/20">
        <AlertDescription>
          <p className="font-medium mb-2 text-warning">No insights available yet</p>
      ...
      {insights.map((insight, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="p-3 rounded-md text-[13px] bg-success/10">
              <p className="font-medium text-xs mb-1 text-success">Recommendation</p>
