          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  {statistical.confidenceLevel}% confidence • p-value:{' '}
                  {statistical.pValue.toFixed(4)}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="h-80">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData} margin={{ top: 20, right: 30, bottom: 20, left: 0 }}>
              ...
              />
              <Legend />
              <Bar dataKey="Variant A" fill="oklch(0.7 0.15 230)" radius={[8, 8, 0, 0]} />
              <Bar dataKey="Variant B" fill="oklch(0.8 0.15 85)" radius={[8, 8, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </CardContent>
