...
export function ExperimentControlPanel({
  ...
  const recommendedVariant =
    statistical.winningVariant !== 'NONE' ? statistical.winningVariant : null
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="font-medium">
                      {results.variantAMetrics.retention.toFixed(1)}%
                    </span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span className="text-muted-foreground">Performance</span>
                    <span className="font-medium">
                      {results.variantAMetrics.performance.toFixed(1)}%
                    </span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span className="text-muted-foreground">Satisfaction</span>
                    <span className="font-medium">
                      {results.variantAMetrics.satisfaction.toFixed(1)}/5
                    </span>
                  </div>
                </div>
                <Button
              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-xs">
                    <span className="text-muted-foreground">Retention</span>
                    <span className="font-medium">
                      {results.variantBMetrics.retention.toFixed(1)}%
                    </span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span className="text-muted-foreground">Performance</span>
                    <span className="font-medium">
                      {results.variantBMetrics.performance.toFixed(1)}%
                    </span>
                  </div>
                  <div className="flex justify-between text-xs">
                    <span className="text-muted-foreground">Satisfaction</span>
                    <span className="font-medium">
                      {results.variantBMetrics.satisfaction.toFixed(1)}/5
                    </span>
                  </div>
                </div>
                <Button
