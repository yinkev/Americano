      ...
      <Card className="bg-white/80 backdrop-blur-md shadow-sm animate-pulse">
        <CardHeader>
          ...
          <div
            ...
            style={{ backgroundColor: 'oklch(0.91 0.02 230)' }}
          />
        ...
        <CardContent>
          <div className="space-y-3">
            ...
            <div
              className="h-4 rounded w-full"
              style={{ backgroundColor: 'oklch(0.93 0.02 230)' }}
            />
            <div
      ...
      <CardHeader>
        <div className="space-y-4">
          ...
          <div>
            ...
            <div
              className={`flex items-center gap-2 ${typography.body.small} text-muted-foreground`}
            >
