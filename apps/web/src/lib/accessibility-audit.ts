 ...
 */
export function auditColorPair(foreground: string, background: string): ColorAudit {
...
export function auditThemeColors(): {
  ...
  const lightAudits: ColorAudit[] = [
    ...
    auditColorPair(COLOR_PALETTE.light.mutedForeground, COLOR_PALETTE.light.background),
    auditColorPair(COLOR_PALETTE.light.primary, COLOR_PALETTE.light.background),
    auditColorPair(COLOR_PALETTE.light.primaryForeground, COLOR_PALETTE.light.primary),
    auditColorPair(COLOR_PALETTE.light.destructiveForeground, COLOR_PALETTE.light.destructive),
    auditColorPair(COLOR_PALETTE.light.successForeground, COLOR_PALETTE.light.success),
  ]

  const darkAudits: ColorAudit[] = [
    auditColorPair(COLOR_PALETTE.dark.foreground, COLOR_PALETTE.dark.background),
    auditColorPair(COLOR_PALETTE.dark.mutedForeground, COLOR_PALETTE.dark.background),
    ...
    auditColorPair(COLOR_PALETTE.dark.destructiveForeground, COLOR_PALETTE.dark.destructive),
    auditColorPair(COLOR_PALETTE.dark.successForeground, COLOR_PALETTE.dark.success),
  ]
