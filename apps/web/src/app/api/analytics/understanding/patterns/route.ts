 ...
 *
 * Fetches strengths, weaknesses, and AI insights.
 * Proxies request to Python FastAPI service for pattern detection.
 */
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await fetch(`${pythonServiceUrl}/analytics/understanding/patterns`, {
      method: 'POST',
    ...
    const validatedData = patternsResponseSchema.parse(data)
