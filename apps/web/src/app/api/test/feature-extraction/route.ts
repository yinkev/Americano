  ...
  try {
    ...
    const assertions = {
      ...
      dataQualityScoreValid:
        featureVector.metadata.dataQuality >= 0 && featureVector.metadata.dataQuality <= 1,
...
function generateRecommendations(
  ...
  if (recommendations.length === 0) {
    recommendations.push(
      '✅ No significant risk factors detected. User appears well-prepared for this objective.',
    )
  }
