  ...
  async reprocessLecture(
    ...
    try {
      ...
      if (analysisResult.success) {
        console.log(`[Orchestrator] Step 2 complete: ${analysisResult.objectivesCount} objectives extracted`);
      } else {
        console.warn(`[Orchestrator] Step 2 warning: ${analysisResult.error} - continuing without objectives`);
      }
      ...
      console.log(`[Orchestrator] Step 3 complete: ${embeddingResult.embeddingsGenerated} embeddings generated`);
